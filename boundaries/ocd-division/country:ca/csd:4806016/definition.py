...
boundaries.register('Calgary wards',
    domain='Calgary, AB',
    last_updated=date(2017, 10, 6),
    name_func=boundaries.clean_attr('LABEL'),
    id_func=lambda f: int(f.get('WARD_NUM')),
    authority='City of Calgary',
    source_url='https://data.calgary.ca/Government/Ward-Boundaries-effective-October-16-2017-/4f6r-atgm',
    licence_url='https://data.calgary.ca/stories/s/u45n-7awa',
    data_url='https://data.calgary.ca/api/geospatial/4f6r-atgm?method=export&format=Shapefile',
    encoding='iso-8859-1',
