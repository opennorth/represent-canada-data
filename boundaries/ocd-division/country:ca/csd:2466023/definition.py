...
boundaries.register('Montréal boroughs and districts',
    ...
    notes='''ogr2ogr -f "ESRI Shapefile" boundaries/ocd-division/country:ca/csd:2466023/merge.shp boundaries/ca_qc_districts/Districts_Mun_2017_11_30.shp -where "CO_MUNCP='66023'" -select NM_ARON,NO_ARON\nogr2ogr -f "ESRI Shapefile" boundaries/ocd-division/country:ca/csd:2466023/merge.shp boundaries/ca_qc_districts/Districts_Mun_2017_11_30.shp -where "CO_MUNCP='66023'" -append -addfields\nLoad the shapefile manually:\nfab alpheus update_boundaries:args="--merge combine -d data/shapefiles/public/boundaries/ocd-division/country:ca/csd:2466023"''',
)
