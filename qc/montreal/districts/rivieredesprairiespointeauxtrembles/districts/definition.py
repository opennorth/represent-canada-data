...
boundaries.register(u'Rivière-des-Prairies—Pointe-aux-Trembles districts',
    ...
    encoding='iso-8859-1',
    metadata={'ocd_division': u'ocd-division/country:ca/csd:2466023/borough:rivière-des-prairies~pointe-aux-trembles'},
    ogr2ogr=u'''-where "ARRONDISSE='Rivière-des-Prairies-Pointe-aux-Trembles'"''',
)
