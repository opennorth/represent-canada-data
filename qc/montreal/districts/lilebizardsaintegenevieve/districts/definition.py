...
boundaries.register(u'L\'Île-Bizard—Sainte-Geneviève districts',
    ...
    encoding='iso-8859-1',
    metadata={'ocd_division': u'ocd-division/country:ca/csd:2466023/borough:l~île-bizard~sainte-geneviève'},
    ogr2ogr=u'''-where "ARRONDISSE='L\'Île-Bizard-Sainte-Geneviève'"''',
)
