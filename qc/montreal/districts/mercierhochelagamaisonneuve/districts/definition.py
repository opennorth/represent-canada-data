...
boundaries.register(u'Mercier—Hochelaga-Maisonneuve districts',
    ...
    encoding='iso-8859-1',
    metadata={'ocd_division': u'ocd-division/country:ca/csd:2466023/borough:mercier~hochelaga-maisonneuve'},
    ogr2ogr=u'''-where "ARRONDISSE='Mercier-Hochelaga-Maisonneuve'"''',
)
