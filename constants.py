...
terms = {
  ...
  'http://www.regina.ca/residents/open-government/data/terms/': 'I. Terms of Use. This data is provided by the City of Regina and is made available under the terms of the Agreement (http://www.regina.ca/residents/open-government/data/terms).',
  'https://www.halifaxopendata.ca/terms': 'I. Terms of Use. This work is provided under the terms of “Halifax Regional Municipality – Terms of Use” (https://www.halifaxopendata.ca/terms).  Any use of the work other than as authorized under these terms is strictly prohibited.',
